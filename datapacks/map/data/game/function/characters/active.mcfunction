...
item replace entity @s[tag=!spirlob,tag=!arena,tag=!lobby,gamemode=!creative,nbt=!{Inventory:[{id:"minecraft:potion",Slot:8b}]}] hotbar.8 with minecraft:potion[custom_name='[{"text":"[","color":"white","italic":false},{"text":"Leave Game","color":"gold","italic":false},{"text":"]","color":"white","italic":false}]']
