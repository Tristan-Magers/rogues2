...
execute if entity @e[tag=project_save_spot,scores={playerID=0},tag=!project_cancel] run tellraw @a [{"text":"* ","color":"white"},{"selector":"@s"},{"text":" ("},{"text":"Barbose","color":"yellow"},{"text":") Died","color":"white"}]
