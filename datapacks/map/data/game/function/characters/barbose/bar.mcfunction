...
execute as @s[scores={Mana=4..}] run item replace entity @s hotbar.4 with ink_sac[custom_name='[{"text":"Smoke Wall","color":"dark_purple","italic":false,"bold":true},{"text":" [","color":"white","italic":false},{"text":"4 Mana","color":"gold","italic":false},{"text":"] (range of 3 blocks)","color":"white","italic":false}]',lore=['{"text":"Send 3 damaging pulses","color":"white","italic":false}','{"text":"6 damage each","color":"green","italic":false}','{"text":"3 block range","color":"red","italic":false}']]
