...
#trident durability
execute as @s[scores={gettri=..-2,trident=1,tridentH=3..,tridentU=1..}] run item replace entity @s hotbar.0 with trident[damage=0,attribute_modifiers={modifiers:[{id:"attack_speed",type:"attack_speed",amount:-2.9,operation:"add_value",slot:"any"},{id:"attack_damage",type:"attack_damage",amount:6,operation:"add_value",slot:"any"}],show_in_tooltip:false},custom_name='[{"text":"Trident","color":"aqua","italic":false,"bold":true},{"text":" [","color":"white","italic":false},{"text":"7 Damage","color":"red","italic":false},{"text":"]","color":"white","italic":false}]',lore=['{"text":"3 durability trident","color":"white","italic":false}','{"text":"7 damage, 0.9s charge","color":"gold","italic":false}','{"text":"Can be thrown","color":"green","italic":false}','{"text":"Riptide in water","color":"green","italic":false}','{"text":"Damaged when unequipped","color":"red","italic":false}']] 1
execute as @s[scores={gettri=..-2,trident=1,tridentH=2,tridentU=1..}] run item replace entity @s hotbar.0 with trident[damage=90,attribute_modifiers={modifiers:[{id:"attack_speed",type:"attack_speed",amount:-2.9,operation:"add_value",slot:"any"},{id:"attack_damage",type:"attack_damage",amount:6,operation:"add_value",slot:"any"}],show_in_tooltip:false},custom_name='[{"text":"Trident","color":"aqua","italic":false,"bold":true},{"text":" [","color":"white","italic":false},{"text":"7 Damage","color":"red","italic":false},{"text":"]","color":"white","italic":false}]',lore=['{"text":"3 durability trident","color":"white","italic":false}','{"text":"7 damage, 0.9s charge","color":"gold","italic":false}','{"text":"Can be thrown","color":"green","italic":false}','{"text":"Riptide in water","color":"green","italic":false}','{"text":"Damaged when unequipped","color":"red","italic":false}']] 1
execute as @s[scores={gettri=..-2,trident=1,tridentH=1,tridentU=1..}] run item replace entity @s hotbar.0 with trident[damage=170,attribute_modifiers={modifiers:[{id:"attack_speed",type:"attack_speed",amount:-2.9,operation:"add_value",slot:"any"},{id:"attack_damage",type:"attack_damage",amount:6,operation:"add_value",slot:"any"}],show_in_tooltip:false},custom_name='[{"text":"Trident","color":"aqua","italic":false,"bold":true},{"text":" [","color":"white","italic":false},{"text":"7 Damage","color":"red","italic":false},{"text":"]","color":"white","italic":false}]',lore=['{"text":"3 durability trident","color":"white","italic":false}','{"text":"7 damage, 0.9s charge","color":"gold","italic":false}','{"text":"Can be thrown","color":"green","italic":false}','{"text":"Riptide in water","color":"green","italic":false}','{"text":"Damaged when unequipped","color":"red","italic":false}']] 1
...
execute as @s[scores={gettri=0}] run item replace entity @s hotbar.0 with trident[unbreakable={show_in_tooltip:false},attribute_modifiers={modifiers:[{id:"attack_speed",type:"attack_speed",amount:-2.9,operation:"add_value",slot:"any"},{id:"attack_damage",type:"attack_damage",amount:6,operation:"add_value",slot:"any"}],show_in_tooltip:false},custom_name='[{"text":"Trident","color":"aqua","italic":false,"bold":true},{"text":" [","color":"white","italic":false},{"text":"7 Damage","color":"red","italic":false},{"text":"]","color":"white","italic":false}]',lore=['{"text":"3 durability trident","color":"white","italic":false}','{"text":"7 damage, 0.9s charge","color":"gold","italic":false}','{"text":"Can be thrown","color":"green","italic":false}','{"text":"Riptide in water","color":"green","italic":false}','{"text":"Damaged when unequipped","color":"red","italic":false}']] 1
...
execute as @s[tag=!spiritworld,scores={Mana=3..},nbt=!{Inventory:[{id:"minecraft:potion",Slot:4b}]}] run item replace entity @s hotbar.4 with potion[custom_data={StormEnergy:1},custom_name='[{"text":"Storm Energy","color":"aqua","italic":false,"bold":true},{"text":" (","color":"white","italic":false},{"text":"Boost/Strength","color":"white","bold":false,"italic":false},{"text":") [","color":"white","italic":false},{"text":"3 Mana","color":"gold","italic":false},{"text":"]","color":"white","italic":false}]',lore=['{"text":"3.9s duration","color":"white","italic":false}','{"text":"+20% speed","color":"green","italic":false}','{"text":"+3 damage on Trident melee","color":"green","italic":false}','{"text":"20% damage resistance","color":"green","italic":false}','{"text":"Jump boost","color":"green","italic":false}','{"text":"Causes particle","color":"red","italic":false}','{"text":"Taking damage interrupts drinking","color":"red","italic":false}'],hide_additional_tooltip={},potion_contents={potion:"minecraft:thick",custom_effects:[{id:"minecraft:speed",amplifier:0,duration:78},{id:"minecraft:jump_boost",amplifier:1,duration:78},{id:"minecraft:resistance",amplifier:0,duration:78}]}]
