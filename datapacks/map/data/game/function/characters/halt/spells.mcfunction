...
execute as @s[nbt={SelectedItem:{id:"minecraft:feather"}}] at @s run item replace entity @s hotbar.0 with minecraft:stone_sword[unbreakable={show_in_tooltip:false},enchantments={levels:{"minecraft:knockback":2}},attribute_modifiers=[{id:"attack_speed",type:"generic.attack_speed",amount:-3.5,operation:"add_value",slot:"any"},{id:"attack_damage",type:"generic.attack_damage",amount:11,operation:"add_value",slot:"any"},{id:"movement_speed",type:"generic.movement_speed",amount:0.05,operation:"add_multiplied_total",slot:"any"}],custom_name='[{"text":"Draining Claw","color":"white","italic":false,"bold":true},{"text":" (","color":"white","italic":false},{"text":"12 Damage","color":"red","italic":false},{"text":") (","color":"white","italic":false},{"text":"Boost on hit","color":"gold","italic":false},{"text":")","color":"white","italic":false}]',lore=['{"text":"Deadly claws that steal health","color":"white","italic":false}','{"text":"2-4 Health steal","color":"green","italic":false}','{"text":"Speed and jump boost on hit","color":"green","italic":false}','{"text":"1 use","color":"red","italic":false}']]
