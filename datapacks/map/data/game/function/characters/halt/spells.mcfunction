...
execute as @s[nbt={SelectedItem:{id:"minecraft:feather"}}] at @s run item replace entity @s hotbar.0 with minecraft:stone_sword[unbreakable={show_in_tooltip:false},attribute_modifiers={modifiers:[{id:"attack_speed",type:"attack_speed",amount:-3.535,operation:"add_value",slot:"any"},{id:"attack_damage",type:"attack_damage",amount:12,operation:"add_value",slot:"any"},{id:"movement_speed",type:"movement_speed",amount:0.05,operation:"add_multiplied_total",slot:"any"}],show_in_tooltip:false},custom_name='[{"text":"Draining Claw","color":"white","italic":false,"bold":true},{"text":" (","color":"white","italic":false},{"text":"13 Damage","color":"red","italic":false},{"text":") (","color":"white","italic":false},{"text":"Boost on hit","color":"gold","italic":false},{"text":")","color":"white","italic":false}]',lore=['{"text":"Deadly claws that steal health","color":"white","italic":false}','{"text":"13 damage, 2.15s charge","color":"gold","italic":false}','{"text":"Critical hit on full charge","color":"green","italic":false}','{"text":"Knockback II","color":"green","italic":false}','{"text":"+5% speed","color":"green","italic":false}','{"text":"2-5 Health steal","color":"green","italic":false}','{"text":"3s speed and jump boost on hit","color":"green","italic":false}','{"text":"1 use","color":"red","italic":false}','{"text":"Breaks if unequipped","color":"red","italic":false}','{"text":"0.6s cooldown","color":"red","italic":false}','{"text":"0.5s to get knockback","color":"red","italic":false}']]
...
scoreboard players remove @s[nbt={SelectedItem:{id:"minecraft:nether_brick"}}] Mana 8
