...
execute as @s[scores={Mana=8..}] run item replace entity @s hotbar.1 with sugar_cane[custom_name='[{"text":"Shadow Spikes","color":"blue","italic":false,"bold":true},{"text":" [","color":"white","italic":false},{"text":"8 Mana","color":"gold","italic":false},{"text":"]","color":"white","italic":false}]',lore=['{"text":"Fires 8, 1 damage spikes","color":"white","italic":false}']]
...
execute as @s[scores={Mana=3..}] run item replace entity @s hotbar.3 with bowl[custom_name='[{"text":"Jump Pad","color":"dark_aqua","italic":false,"bold":true},{"text":" [","color":"white","italic":false},{"text":"3 Mana","color":"gold","italic":false},{"text":"]","color":"white","italic":false}]',lore=['{"text":"Throws a jump pad","color":"white","italic":false}']]
