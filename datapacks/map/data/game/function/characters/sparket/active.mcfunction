...
#correct fist
item replace entity @s[scores={wtimer=60}] hotbar.0 with minecraft:wooden_sword[enchantments={levels:{"minecraft:fire_aspect":1,"minecraft:knockback":1}},attribute_modifiers=[{id:"attack_speed",type:"generic.attack_speed",amount:-2.1,operation:"add_value",slot:"any"},{id:"attack_damage",type:"generic.attack_damage",amount:3,operation:"add_value",slot:"any"},{id:"movement_speed",type:"generic.movement_speed",amount:0.26,operation:"add_multiplied_total",slot:"any"}],custom_name='[{"text":"Fire Fist","color":"gold","italic":false,"bold":true},{"text":" [","color":"white","italic":false},{"text":"4 Damage","color":"red","italic":false},{"text":"]","color":"white","italic":false}]'] 1
