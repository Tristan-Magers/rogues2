...
#correct fist
item replace entity @s[scores={wtimer=60}] hotbar.0 with minecraft:wooden_sword[unbreakable={show_in_tooltip:false},hide_additional_tooltip={},enchantments={levels:{"minecraft:fire_aspect":1,"minecraft:knockback":1},show_in_tooltip:false},attribute_modifiers={modifiers:[{id:"attack_speed",type:"generic.attack_speed",amount:-2.31,operation:"add_value",slot:"any"},{id:"attack_damage",type:"generic.attack_damage",amount:3,operation:"add_value",slot:"any"},{id:"movement_speed",type:"generic.movement_speed",amount:0.26,operation:"add_multiplied_total",slot:"any"}],show_in_tooltip:false},custom_name='[{"text":"Fire Fist","color":"gold","italic":false,"bold":true},{"text":" [","color":"white","italic":false},{"text":"4 Damage","color":"red","italic":false},{"text":"]","color":"white","italic":false}]',lore=['{"text":"A fist to damage and ignite your foes","color":"white","italic":false}','{"text":"4 damage, 0.6s charge","color":"gold","italic":false}','{"text":"+26% speed","color":"green","italic":false}','{"text":"3s fire (3 damage)","color":"green","italic":false}','{"text":"Knockback (reduced)","color":"green","italic":false}','{"text":"0.4s delay","color":"red","italic":false}']] 1
