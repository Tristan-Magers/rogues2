...
execute as @s[scores={Mana=6..,wtimer=..0},nbt=!{Inventory:[{id:"minecraft:coal",Slot:0b}]}] run item replace entity @s hotbar.0 with coal[custom_name='[{"text":"Fire Fist","color":"dark_red","italic":false,"bold":true},{"text":" (","color":"white","italic":false},{"text":"3s","color":"green","italic":false},{"text":") [","color":"white","italic":false},{"text":"6 Mana","color":"gold","italic":false},{"text":"]","color":"white","italic":false}]',lore=['{"text":"A fist to damage and ignite your foes","color":"white","italic":false}','{"text":"4 max damage, fast charge","color":"gold","italic":false}','{"text":"+26% speed","color":"green","italic":false}']]
...
execute as @s[scores={Mana=7..,burnout=..0,burnoutT=..0},nbt=!{Inventory:[{id:"minecraft:blaze_powder",Slot:3b}]}] run item replace entity @s hotbar.3 with blaze_powder[custom_name='[{"text":"Burnout","color":"red","italic":false,"bold":true},{"text":" [","color":"white","italic":false},{"text":"7 Mana","color":"gold","italic":false},{"text":"]","color":"white","italic":false}]',lore=['{"text":"Dash forward!","color":"white","italic":false}']]
...
execute as @s[scores={Mana=0..}] run item replace entity @s hotbar.5 with gold_ingot[custom_name='[{"text":"Healing Fire","color":"gold","italic":false,"bold":true},{"text":" (passive effect)","color":"white","italic":false,"bold":false}]',lore=['{"text":"Heal after not taking damage for 9.5 seconds","color":"white","italic":false}','{"text":"And every 3 seconds past that","color":"gold","italic":false}','{"text":"(heal sound only heard by you)","color":"dark_aqua","italic":false}']]
