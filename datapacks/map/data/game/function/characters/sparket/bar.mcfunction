...
execute as @s[scores={Mana=6..,wtimer=..0},nbt=!{Inventory:[{id:"minecraft:coal",Slot:0b}]}] run item replace entity @s hotbar.0 with coal[custom_name='[{"text":"Fire Fist","color":"dark_red","italic":false,"bold":true},{"text":" (","color":"white","italic":false},{"text":"3s","color":"green","italic":false},{"text":") [","color":"white","italic":false},{"text":"6 Mana","color":"gold","italic":false},{"text":"]","color":"white","italic":false}]',lore=['{"text":"A fist to damage and ignite your foes","color":"white","italic":false}','{"text":"4 damage, 0.6s charge","color":"gold","italic":false}','{"text":"+26% speed","color":"green","italic":false}','{"text":"0.4s delay","color":"red","italic":false}']]
