...
execute as @s[scores={Mana=6..,wtimer=..0},nbt=!{Inventory:[{id:"minecraft:coal",Slot:0b}]}] run item replace entity @s hotbar.0 with coal[custom_name='[{"text":"Fire Fist","color":"dark_red","italic":false,"bold":true},{"text":" (","color":"white","italic":false},{"text":"3s","color":"green","italic":false},{"text":") [","color":"white","italic":false},{"text":"6 Mana","color":"gold","italic":false},{"text":"]","color":"white","italic":false}]',lore=['{"text":"A fist to damage and ignite your foes","color":"white","italic":false}','{"text":"5 damage, 0.75s charge","color":"gold","italic":false}','{"text":"+26% speed","color":"green","italic":false}','{"text":"2s fire (2 damage)","color":"green","italic":false}','{"text":"Knockback (reduced)","color":"green","italic":false}','{"text":"0.4s delay","color":"red","italic":false}','{"text":"Throw/offhand to break","color":"white","italic":false}']]
execute as @s[scores={Mana=8..,btimer=..0},nbt=!{Inventory:[{id:"minecraft:charcoal",Slot:1b}]}] run item replace entity @s hotbar.1 with charcoal[custom_name='[{"text":"Flame Bow","color":"red","italic":false,"bold":true},{"text":" (","color":"white","italic":false},{"text":"2 Arrows","color":"aqua","italic":false},{"text":") [","color":"white","italic":false},{"text":"8 Mana","color":"gold","italic":false},{"text":"]","color":"white","italic":false}]',lore=['{"text":"A bow that sets players on fire!","color":"white","italic":false}','{"text":"7 max damage","color":"gold","italic":false}','{"text":"2s fire (2 damage)","color":"green","italic":false}','{"text":"Only 2 arrows","color":"red","italic":false}']]
