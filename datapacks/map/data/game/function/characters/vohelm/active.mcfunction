...
execute as @s[tag=!spiritworld,scores={Mana=4..},nbt=!{Inventory:[{id:"minecraft:golden_apple",Slot:4b}]}] run item replace entity @s hotbar.4 with golden_apple[custom_name='[{"text":"Sacred Berries","color":"green","italic":false,"bold":true},{"text":" (","color":"white","italic":false},{"text":"Heal 4","color":"red","italic":false},{"text":") [","color":"white","italic":false},{"text":"4 Mana","color":"gold","italic":false},{"text":"]","color":"white","italic":false}]',lore=['{"text":"Heal 4 health","color":"green","italic":false}','{"text":"3s of +20% speed","color":"green","italic":false}','{"text":"Taking damage interupts eating","color":"red","italic":false}']]
...
execute as @s at @s if entity @e[tag=totem,distance=..6.5,scores={playerID=0,gertimer=..9990}] run attribute @s minecraft:generic.attack_damage base set 3
...
execute as @s at @s if entity @e[tag=totem,distance=..6.75,scores={playerID=0,gertimer=..9990}] run execute as @e[tag=totem,distance=..6.75,scores={playerID=0}] at @s run particle dust{color:[1.000,0.500,0.500],scale:1} ~ ~1 ~ .3 .5 .3 0 2 force
execute as @s at @s if entity @e[tag=totem,distance=..6.75,scores={playerID=0,gertimer=..9990}] run particle dust{color:[1.000,0.500,0.500],scale:1} ~ ~1 ~ .3 .5 .3 0 2 force
execute as @s at @s if entity @e[tag=totem,distance=..6.75,scores={playerID=0,gertimer=..9990}] run tag @s add totemdust
...
execute as @s at @s run execute as @e[tag=totem,distance=6.75..,scores={playerID=0,gertimer=..9990}] at @s run scoreboard players set @s gertimer 9990
scoreboard players operation @e[tag=totem] playerID += @s playerID
...
#
execute as @a run attribute @s[scores={sword_boost=1..}] minecraft:generic.movement_speed base set .118
