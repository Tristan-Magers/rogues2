item replace entity @s[scores={shield=2..},nbt=!{Inventory:[{id:"minecraft:iron_chestplate",Slot:102b}]}] armor.chest with minecraft:iron_chestplate[attribute_modifiers=[{id:"armor",type:"armor",amount:0,operation:"add_multiplied_base"}]]
