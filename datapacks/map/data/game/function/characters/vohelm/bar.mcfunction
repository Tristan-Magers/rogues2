...
execute as @s[scores={Mana=6..,shieldT=..0}] run item replace entity @s hotbar.2 with sugar[custom_name='[{"text":"Shield","color":"aqua","italic":false,"bold":true},{"text":" (","color":"white","italic":false},{"text":"2.2s","color":"green","italic":false},{"text":") [","color":"white","italic":false},{"text":"6 Mana","color":"gold","italic":false},{"text":"]","color":"white","italic":false}]',lore=['{"text":"2.2s of invulnerability","color":"white","italic":false}','{"text":"Extinguishes fire","color":"green","italic":false}','{"text":"0.75s cooldown","color":"red","italic":false}']]
