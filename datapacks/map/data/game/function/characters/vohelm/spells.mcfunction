...
execute as @s[scores={Mana=2..},nbt={SelectedItem:{id:"minecraft:golden_hoe"}}] at @s run item replace entity @s hotbar.0 with minecraft:diamond_hoe[unbreakable={show_in_tooltip:false},enchantments={levels:{"minecraft:knockback":1}},attribute_modifiers={modifiers:[{id:"attack_speed",type:"generic.attack_speed",amount:-2.8,operation:"add_value",slot:"any"},{id:"attack_damage",type:"generic.attack_damage",amount:6,operation:"add_value",slot:"any"},{id:"movement_speed",type:"generic.movement_speed",amount:0.05,operation:"add_multiplied_total",slot:"any"}],show_in_tooltip:false},custom_name='[{"text":"Sacred Knife","color":"white","italic":false,"bold":true},{"text":" (","color":"white","italic":false},{"text":"7 Damage","color":"red","italic":false},{"text":") [","color":"white","italic":false},{"text":"FULLY UPGRADED","color":"gold","italic":false},{"text":"]","color":"white","italic":false}]',lore=['{"text":"MAX UPGRADE :D","color":"gold","italic":false}','{"text":"7 damage / 0.8s charge","color":"gold","italic":false}','{"text":"+5% speed","color":"green","italic":false}','{"text":"+19% Speed on upgrade for 1.6s","color":"green","italic":false}','{"text":"Degrades if not held","color":"red","italic":false}','{"text":"Offhand to reset levels","color":"gold","italic":false}']] 1
