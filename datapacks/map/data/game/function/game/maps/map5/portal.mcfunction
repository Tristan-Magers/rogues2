...
execute positioned -1043.0 64 -1023.0 run effect give @a[gamemode=adventure,distance=..100,dx=6,dz=1,dy=6,scores={notele=..0}] blindness 1 0 true

execute positioned 70.51 25 -43.5 run tp @a[gamemode=adventure,distance=..100,dz=2.2,dx=10,dy=25,scores={notele=..0}] -1041 64 -1020 0 0
execute positioned -1043.0 64 -1023.0 run execute as @a[gamemode=adventure,distance=..100,dx=6,dz=1,dy=6,scores={notele=..0}] at @s run tp @s 69 38.3 -30 180 0
...
execute positioned -1057 53 -981.0 run effect give @a[gamemode=adventure,distance=..100,dz=5,dx=5,dy=5,scores={notele=..0}] blindness 1 0 true

execute positioned 68.01 25 -43.5 run tp @a[gamemode=adventure,distance=..100,dz=2.2,dx=-10,dy=25,scores={notele=..0}] -1055 53 -983 180 0
execute positioned -1057 53 -981.0 run execute as @a[gamemode=adventure,distance=..100,dz=5,dx=5,dy=5,scores={notele=..0}] at @s run tp @s 69 38.3 -30 180 0
