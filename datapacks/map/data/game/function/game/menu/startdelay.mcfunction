...
execute if entity @e[scores={restartcool=1..}] run title @a[x=-87,y=40,z=65,distance=..10] actionbar {"text":"! Game Resetting !","color":"white","font":"fancy"}
...
execute if block -88 41 65 minecraft:polished_blackstone_button[face=floor,powered=true,facing=east] run title @a[x=-87,y=40,z=65,distance=..10] actionbar {"text":"! Cancelled !","color":"white","font":"fancy"}
...
execute if entity @e[scores={Time=1..}] run title @a[x=-87,y=40,z=65,distance=..10] actionbar {"text":"! Game in progress. !","color":"white","font":"fancy"}
execute if entity @e[scores={Time=1..}] run scoreboard players set @s startdelay 1

execute unless entity @a[tag=ready] run title @a[x=-87,y=40,z=65,distance=..10] actionbar {"text":"! Requires a 'ready' player. !","color":"white","font":"fancy"}
...
execute as @s[scores={startdelay=140}] run title @a title {"text":"Portal Opening","font":"fancy"}
execute as @s[scores={startdelay=140}] run title @a subtitle {"text":"5","font":"fancy"}
...
execute as @s[scores={startdelay=120}] run title @a title {"text":"Portal Opening","font":"fancy"}
execute as @s[scores={startdelay=120}] run title @a subtitle {"text":"4","color":"yellow","font":"fancy"}
...
execute as @s[scores={startdelay=100}] run title @a title {"text":"Portal Opening","font":"fancy"}
execute as @s[scores={startdelay=100}] run title @a subtitle {"text":"3","color":"gold","font":"fancy"}
...
execute as @s[scores={startdelay=80}] run title @a title {"text":"Portal Opening","font":"fancy"}
execute as @s[scores={startdelay=80}] run title @a subtitle {"text":"2","color":"red","font":"fancy"}
...
execute as @s[scores={startdelay=60}] run title @a title {"text":"Portal Opening","font":"fancy"}
execute as @s[scores={startdelay=60}] run title @a subtitle {"text":"1","color":"dark_red","font":"fancy"}
...
execute as @s[scores={startdelay=40}] run title @a title {"text":"Worlds Collide","color":"dark_aqua","font":"fancy"}
