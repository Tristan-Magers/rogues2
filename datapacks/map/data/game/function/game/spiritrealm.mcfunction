...
execute as @s[tag=!spiritworld] at @s run title @s title [{"text":"Spirit ","color":"dark_aqua","font":"fancy"},{"text":"Realm","color":"dark_aqua","font":"fancy"}]
execute as @s[tag=!spiritworld] at @s run title @s subtitle [{"text":"Home of souls","color":"aqua","font":"fancy"}]
...
execute as @s[scores={class=3}] run item replace entity @s hotbar.4 with barrier[custom_name='{"color":"white","italic":false,"text":"Reloading"}'] 1

execute as @s[scores={class=2}] run item replace entity @s hotbar.4 with barrier[custom_name='{"color":"white","italic":false,"text":"Reloading"}'] 1
execute as @s[scores={class=2}] run item replace entity @s hotbar.0 with barrier[custom_name='{"color":"white","italic":false,"text":"Reloading"}'] 1

execute as @s[scores={class=5}] run item replace entity @s hotbar.0 with barrier[custom_name='{"color":"white","italic":false,"text":"Reloading"}'] 1
execute as @s[scores={class=5}] run item replace entity @s hotbar.1 with barrier[custom_name='{"color":"white","italic":false,"text":"Reloading"}'] 1
