...
execute as @a[scores={Score=1..},tag=game] run scoreboard players operation @s tpoints = @s Score
scoreboard players operation .highest tpoints > @a[scores={Score=1..},tag=game] tpoints
execute as @a[scores={Score=1..},tag=game] run scoreboard players operation @s tpoints -= .highest tpoints
