...
item replace entity @s[tag=!spiritworld,scores={item=2},nbt=!{Inventory:[{id:"minecraft:golden_boots",Slot:100b}]}] armor.feet with golden_boots[attribute_modifiers={modifiers:[{id:"armor",type:"generic.armor",amount:0,operation:"add_multiplied_base",slot:"any"}],show_in_tooltip:false}] 1
...
item replace entity @s[tag=!spiritworld,nbt=!{Inventory:[{id:"minecraft:golden_leggings",Slot:101b}]}] armor.legs with golden_leggings[enchantments={levels:{"minecraft:swift_sneak":1},show_in_tooltip:false},attribute_modifiers={modifiers:[{id:"armor",type:"generic.armor",amount:0,operation:"add_multiplied_base",slot:"any"}],show_in_tooltip:false}] 1
