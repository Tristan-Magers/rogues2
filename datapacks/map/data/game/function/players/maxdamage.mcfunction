...
scoreboard players set @s[scores={class=2},tag=has_totem,nbt={SelectedItem:{id:"minecraft:wooden_hoe"}}] damageCap 50
scoreboard players set @s[scores={class=2},tag=has_totem,nbt={SelectedItem:{id:"minecraft:stone_hoe"}}] damageCap 60
scoreboard players set @s[scores={class=2},tag=has_totem,nbt={SelectedItem:{id:"minecraft:iron_hoe"}}] damageCap 70
scoreboard players set @s[scores={class=2},tag=has_totem,nbt={SelectedItem:{id:"minecraft:golden_hoe"}}] damageCap 80
scoreboard players set @s[scores={class=2},tag=has_totem,nbt={SelectedItem:{id:"minecraft:diamond_hoe"}}] damageCap 90
...
scoreboard players set @s[scores={class=5},nbt={SelectedItem:{id:"minecraft:stone_sword"}}] damageCap 129
