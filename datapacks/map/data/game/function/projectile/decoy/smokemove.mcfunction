...
execute as @s at @s if entity @e[limit=1,type=area_effect_cloud,tag=smoker,scores={playerID=0}] run particle dust{color:[0.800,0.800,0.800],scale:1} ~ ~.2 ~ .1 .1 .1 0 1 force
