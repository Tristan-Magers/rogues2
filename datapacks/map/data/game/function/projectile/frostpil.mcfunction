...
execute as @s[scores={frost=36..}] at @s positioned ~-.5 ~ ~-.5 run fill ~ 0 ~ ~1 ~3 ~1 air replace minecraft:packed_ice
execute as @s[scores={frost=36..}] at @s run execute as @e[tag=frostwall,type=!player,scores={frost=2..35}] at @s positioned ~-.5 ~ ~-.5 run fill ~ 0 ~ ~1 ~3 ~1 minecraft:packed_ice replace air
kill @s[scores={frost=36..}]
