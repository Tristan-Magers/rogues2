...
execute as @s[tag=kill] at @s run scoreboard players operation @a playerID -= @s playerID
execute as @s[tag=kill] at @s run scoreboard players set @p[scores={playerID=0,respawn=..0},distance=0.1..100] soul_send_count_t -1
