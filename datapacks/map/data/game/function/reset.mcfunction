...
#version sign
data merge block -101 41 64 {front_text:{messages:['{"text":""}','{"text":"Version 2.1.2","bold":true}','{"text":"click for changes","italic":true,"clickEvent":{"action":"run_command","value":"/tag @s add notesclick"}}','{"text":""}']}}
