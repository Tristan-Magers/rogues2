...
item replace entity @s[gamemode=!creative,tag=!vengeuse] hotbar.6 with minecraft:book[custom_name='[{"text":"VENGENCE","color":"red","italic":false,"bold":true},{"text":" [","color":"white","italic":false},{"text":"1 Use","color":"gold","italic":false},{"text":"] (15 seconds X2 Mana and Heal)","color":"white","italic":false}]']
