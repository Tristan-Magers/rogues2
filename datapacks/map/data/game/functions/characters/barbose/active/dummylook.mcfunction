execute if entity @s[scores={dummylook=54}] positioned ~ ~-20 ~ run summon minecraft:creeper ~ ~ ~ {NoAI:1,NoGravity:1,Marker:1,Silent:1,Silent:1,Invulnerable:0,Tags:["smokerloc"],Invisible:1,Duration:999999,Silent:1}
...
execute if entity @s[scores={dummylook=54}] positioned ~ ~-20 ~ run effect give @e[tag=smokerloc] minecraft:instant_health 999 99 true
