...
summon minecraft:slime ~ ~.5 ~ {Size:0,ActiveEffects:[{Id:14b,Amplifier:1b,Duration:1000}],Tags:["gernade"],Invulnerable:1,Attributes:[{Name:generic.follow_range,Base:0},{Name:generic.movement_speed,Base:-1},{Name:generic.attack_damage,Base:0},{Name:generic.attackKnockback,Base:0}],Passengers:[{id:"minecraft:armor_stand",Small:1,Marker:1,Invulnerable:1,Tags:["head"],Invisible:1,ArmorItems:[{},{},{},{Count:1,id:lime_dye}],DisabledSlots:4144959}]}
