...
clear @s[scores={Mana=..8,btimer=..0}] nether_brick
...
execute as @s[scores={Mana=8..,btimer=..0}] run replaceitem entity @s hotbar.1 nether_brick{display:{Name:"[{\"text\":\"Ghost Shot\",\"color\":\"red\",\"italic\":\"false\",\"bold\":\"true\"},{\"text\":\" (\",\"color\":\"white\",\"italic\":\"false\"},{\"text\":\"3 Arrows\",\"color\":\"aqua\",\"italic\":\"false\"},{\"text\":\") [\",\"color\":\"white\",\"italic\":\"false\"},{\"text\":\"8 Mana\",\"color\":\"gold\",\"italic\":\"false\"},{\"text\":\"]\",\"color\":\"white\",\"italic\":\"false\"}]"}}
