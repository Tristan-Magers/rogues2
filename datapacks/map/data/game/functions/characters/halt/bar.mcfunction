...
execute as @s[scores={Mana=4..,wtimer=..0}] run replaceitem entity @s hotbar.0 feather{display:{Name:"[{\"text\":\"Draining Claw\",\"color\":\"gray\",\"italic\":\"false\",\"bold\":\"true\"},{\"text\":\" (\",\"color\":\"white\",\"italic\":\"false\"},{\"text\":\"one hit\",\"color\":\"red\",\"italic\":\"false\"},{\"text\":\") [\",\"color\":\"white\",\"italic\":\"false\"},{\"text\":\"4 Mana\",\"color\":\"gold\",\"italic\":\"false\"},{\"text\":\"] (Boost and heal on hit)\",\"color\":\"white\",\"italic\":\"false\"}]"}}
