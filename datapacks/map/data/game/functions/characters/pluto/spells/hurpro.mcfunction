...
execute as @s[scores={arrowmot=..11664}] at @s run summon minecraft:armor_stand ~ ~ ~ {NoGravity:1,Marker:1,Invulnerable:1,Tags:["hurpro"],ArmorItems:[{},{},{},{Count:1,id:redstone}],Invisible:1}
execute as @s[scores={arrowmot=11665..46656}] at @s run summon minecraft:armor_stand ~ ~ ~ {NoGravity:1,Marker:1,Invulnerable:1,Tags:["hurpro"],ArmorItems:[{},{},{},{Count:1,id:scute}],Invisible:1}
execute as @s[scores={arrowmot=46657..104976}] at @s run summon minecraft:armor_stand ~ ~ ~ {NoGravity:1,Marker:1,Invulnerable:1,Tags:["hurpro"],ArmorItems:[{},{},{},{Count:1,id:stick}],Invisible:1}
execute as @s[scores={arrowmot=104977..186624}] at @s run summon minecraft:armor_stand ~ ~ ~ {NoGravity:1,Marker:1,Invulnerable:1,Tags:["hurpro"],ArmorItems:[{},{},{},{Count:1,id:wheat}],Invisible:1}
execute as @s[scores={arrowmot=186625..291600}] at @s run summon minecraft:armor_stand ~ ~ ~ {NoGravity:1,Marker:1,Invulnerable:1,Tags:["hurpro"],ArmorItems:[{},{},{},{Count:1,id:wheat_seeds}],Invisible:1}
execute as @s[scores={arrowmot=291601..}] at @s run summon minecraft:armor_stand ~ ~ ~ {NoGravity:1,Marker:1,Invulnerable:1,Tags:["hurpro"],ArmorItems:[{},{},{},{Count:1,id:gunpowder}],Invisible:1}
