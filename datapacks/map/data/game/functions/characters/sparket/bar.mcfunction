...
execute as @s[scores={Mana=4..},nbt=!{Inventory:[{id:"minecraft:blaze_rod",Slot:2b}]}] run replaceitem entity @s hotbar.2 blaze_rod{display:{Name:"[{\"text\":\"Fire Breath\",\"color\":\"dark_red\",\"italic\":\"false\",\"bold\":\"true\"},{\"text\":\" [\",\"color\":\"white\",\"italic\":\"false\"},{\"text\":\"4 Mana\",\"color\":\"gold\",\"italic\":\"false\"},{\"text\":\"]\",\"color\":\"white\",\"italic\":\"false\"}]"}}
