...
#fire fist
scoreboard players set @s[nbt={SelectedItem:{id:"minecraft:coal"}}] wtimer 81
scoreboard players remove @s[nbt={SelectedItem:{id:"minecraft:coal"}}] Mana 7
execute as @s[nbt={SelectedItem:{id:"minecraft:coal"}}] at @s run replaceitem entity @s hotbar.0 minecraft:wooden_sword{Enchantments:[{id:"minecraft:knockback",lvl:1},{id:"minecraft:fire_aspect",lvl:1}],AttributeModifiers:[{AttributeName:"generic.movementSpeed",Name:"generic.movementSpeed",Amount:0.75,Operation:2,UUIDLeast:690452,UUIDMost:338207,Slot:"mainhand"},{AttributeName:"generic.attackSpeed",Name:"generic.attackSpeed",Amount:-.6,Operation:2,UUIDLeast:288149,UUIDMost:584828,Slot:"mainhand"},{AttributeName:"generic.attackDamage",Name:"generic.attackDamage",Amount:4,Operation:0,UUIDLeast:410853,UUIDMost:718299,Slot:"mainhand"}],display:{Name:"[{\"text\":\"Fire Fist\",\"color\":\"gold\",\"italic\":\"false\",\"bold\":\"true\"},{\"text\":\" [\",\"color\":\"white\",\"italic\":\"false\"},{\"text\":\"5 Damage\",\"color\":\"red\",\"italic\":\"false\"},{\"text\":\"]\",\"color\":\"white\",\"italic\":\"false\"}]"}} 1

#flame bow
scoreboard players set @s[nbt={SelectedItem:{id:"minecraft:charcoal"}}] btimer 2
scoreboard players remove @s[nbt={SelectedItem:{id:"minecraft:charcoal"}}] Mana 9
execute as @s[nbt={SelectedItem:{id:"minecraft:charcoal"}}] at @s run replaceitem entity @s hotbar.1 minecraft:bow{Enchantments:[{id:"minecraft:flame",lvl:1}]} 1
...
scoreboard players remove @s[scores={FBreload=..0},nbt={SelectedItem:{id:"minecraft:blaze_rod"}}] Mana 3
...
scoreboard players remove @s[nbt={SelectedItem:{id:"minecraft:blaze_powder"}}] Mana 8
...
execute as @s[nbt={SelectedItem:{id:"minecraft:brick"}}] at @s run effect give @p minecraft:slow_falling 4 0 true
execute as @s[nbt={SelectedItem:{id:"minecraft:brick"}}] at @s run effect give @p minecraft:jump_boost 4 4 true
scoreboard players remove @s[nbt={SelectedItem:{id:"minecraft:brick"}}] Mana 4
scoreboard players set @s[nbt={SelectedItem:{id:"minecraft:brick"}}] boostT 81