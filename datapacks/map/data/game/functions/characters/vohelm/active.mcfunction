...
execute as @s at @s if entity @e[tag=totem,distance=..6.5,scores={playerID=0,gertimer=..9990}] run execute as @e[tag=totem,distance=..8,scores={playerID=0}] at @s run particle dust 1.0 0.5 0.5 1.0 ~ ~1 ~ .3 .5 .3 0 2 force
execute as @s at @s if entity @e[tag=totem,distance=..6.5,scores={playerID=0,gertimer=..9990}] run particle dust 1.0 0.5 0.5 1.0 ~ ~.2 ~ .2 .1 .2 0 2 force
