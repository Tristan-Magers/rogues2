...
execute as @s[scores={gertimer=10006..}] at @s run scoreboard players set @e[distance=..4,name=web] move 1045
execute as @s[scores={gertimer=10006..}] at @s run summon creeper ~ ~ ~ {ignited:1,Fuse:0,ExplosionRadius:2}
execute as @s[scores={gertimer=10006..}] at @s run tp @s ~ ~-1000 ~
