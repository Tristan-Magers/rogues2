...
scoreboard players remove @s[nbt={SelectedItem:{id:"minecraft:bone"}}] Mana 5
...
execute as @s[scores={Mana=3..},nbt={SelectedItem:{id:"minecraft:golden_hoe"}}] at @s run playsound minecraft:item.armor.equip_gold master @a ~ ~ ~ .4 1.7
...
execute as @s[scores={Mana=3..},nbt={SelectedItem:{id:"minecraft:golden_hoe"}}] at @s run playsound minecraft:item.armor.equip_gold master @s ~ ~ ~ .8 1.7
