...
#totem
execute as @s[nbt={SelectedItem:{id:"minecraft:bone"}}] at @s run summon minecraft:vindicator ~ ~ ~ {Health:3,Tags:["totem"],Invulnerable:0b,IsBaby:0b,ArmorItems:[{id:"minecraft:golden_boots",Count:1b,tag:{Enchantments:[{id:"minecraft:feather_falling",lvl:255s}],AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:0,Operation:0,UUID:[I;-1985527705,1090732223,-1537278005,-610143563]}]}},{},{},{id:"minecraft:bamboo",Count:1b}],Attributes:[{Name:generic.follow_range,Base:0},{Name:generic.movement_speed,Base:0},{Name:generic.attack_damage,Base:0}],Silent:1}
