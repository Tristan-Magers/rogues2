...
execute as @s[scores={pointsT=800..,people=1..}] at @s positioned ~-1 ~-2 ~-1 run title @a[gamemode=adventure,distance=..100,dx=1,dz=1,dy=3] title [{"text":" "}]
execute as @s[scores={pointsT=800..,people=1..}] at @s positioned ~-1 ~-2 ~-1 run scoreboard players set @a[gamemode=adventure,distance=..100,dx=1,dz=1,dy=3] pointtut -300
execute as @s[scores={pointsT=800..,people=1}] at @s positioned ~-1 ~-2 ~-1 run title @a[gamemode=adventure,distance=..100,dx=1,dz=1,dy=3,scores={nocap=..0}] times 0 3 10
execute as @s[scores={pointsT=800..,people=1}] at @s positioned ~-1 ~-2 ~-1 run title @a[gamemode=adventure,distance=..100,dx=1,dz=1,dy=3,scores={nocap=..0}] subtitle [{"text":"Capturing Soul"}]
execute as @s[scores={pointsT=800..,people=1}] at @s positioned ~-1 ~-2 ~-1 run title @a[gamemode=adventure,distance=..100,dx=1,dz=1,dy=3,scores={nocap=1..}] subtitle [{"text":"Capture Blocked","color":"dark_purple"}]
