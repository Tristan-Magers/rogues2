...
execute as @s[tag=hurpro] at @s positioned ~ ~ ~ run execute as @e[tag=hittest,tag=!isthrow,distance=..5] at @s positioned ~-.95 ~-1.7 ~-.95 run tag @e[dx=0.7,dz=0.7,dy=1.9,tag=hurpro,distance=..5] remove in
execute as @s[tag=hurpro] at @s positioned ~ ~ ~ run execute as @e[tag=hittest,distance=..5] at @s positioned ~-.95 ~-1.7 ~-.95 if entity @e[dx=0.7,dz=0.7,dy=1.9,tag=hurpro,distance=..5] run tag @s add gethit
