...
execute as @s[scores={healthreal=1}] at @s run summon minecraft:armor_stand ~ ~ ~ {Marker:1,Invulnerable:1,Tags:["damnum"],CustomNameVisible:1b,Duration:999999,CustomName:'{"text":"-1"}'}
execute as @s[scores={healthreal=2}] at @s run summon minecraft:armor_stand ~ ~ ~ {Marker:1,Invulnerable:1,Tags:["damnum"],CustomNameVisible:1b,Duration:999999,CustomName:'{"text":"-2"}'}
execute as @s[scores={healthreal=3}] at @s run summon minecraft:armor_stand ~ ~ ~ {Marker:1,Invulnerable:1,Tags:["damnum"],CustomNameVisible:1b,Duration:999999,CustomName:'{"text":"-3"}'}
execute as @s[scores={healthreal=4}] at @s run summon minecraft:armor_stand ~ ~ ~ {Marker:1,Invulnerable:1,Tags:["damnum"],CustomNameVisible:1b,Duration:999999,CustomName:'{"text":"-4"}'}
execute as @s[scores={healthreal=5}] at @s run summon minecraft:armor_stand ~ ~ ~ {Marker:1,Invulnerable:1,Tags:["damnum"],CustomNameVisible:1b,Duration:999999,CustomName:'{"text":"-5"}'}
execute as @s[scores={healthreal=6}] at @s run summon minecraft:armor_stand ~ ~ ~ {Marker:1,Invulnerable:1,Tags:["damnum"],CustomNameVisible:1b,Duration:999999,CustomName:'{"text":"-6"}'}
execute as @s[scores={healthreal=7}] at @s run summon minecraft:armor_stand ~ ~ ~ {Marker:1,Invulnerable:1,Tags:["damnum"],CustomNameVisible:1b,Duration:999999,CustomName:'{"text":"-7"}'}
execute as @s[scores={healthreal=8}] at @s run summon minecraft:armor_stand ~ ~ ~ {Marker:1,Invulnerable:1,Tags:["damnum"],CustomNameVisible:1b,Duration:999999,CustomName:'{"text":"-8"}'}
execute as @s[scores={healthreal=9}] at @s run summon minecraft:armor_stand ~ ~ ~ {Marker:1,Invulnerable:1,Tags:["damnum"],CustomNameVisible:1b,Duration:999999,CustomName:'{"text":"-9"}'}
execute as @s[scores={healthreal=10}] at @s run summon minecraft:armor_stand ~ ~ ~ {Marker:1,Invulnerable:1,Tags:["damnum"],CustomNameVisible:1b,Duration:999999,CustomName:'{"text":"-10"}'}
execute as @s[scores={healthreal=11}] at @s run summon minecraft:armor_stand ~ ~ ~ {Marker:1,Invulnerable:1,Tags:["damnum"],CustomNameVisible:1b,Duration:999999,CustomName:'{"text":"-11"}'}
execute as @s[scores={healthreal=12}] at @s run summon minecraft:armor_stand ~ ~ ~ {Marker:1,Invulnerable:1,Tags:["damnum"],CustomNameVisible:1b,Duration:999999,CustomName:'{"text":"-12"}'}
execute as @s[scores={healthreal=13}] at @s run summon minecraft:armor_stand ~ ~ ~ {Marker:1,Invulnerable:1,Tags:["damnum"],CustomNameVisible:1b,Duration:999999,CustomName:'{"text":"-13"}'}
execute as @s[scores={healthreal=14}] at @s run summon minecraft:armor_stand ~ ~ ~ {Marker:1,Invulnerable:1,Tags:["damnum"],CustomNameVisible:1b,Duration:999999,CustomName:'{"text":"-14"}'}
execute as @s[scores={healthreal=15}] at @s run summon minecraft:armor_stand ~ ~ ~ {Marker:1,Invulnerable:1,Tags:["damnum"],CustomNameVisible:1b,Duration:999999,CustomName:'{"text":"-15"}'}
execute as @s[scores={healthreal=16}] at @s run summon minecraft:armor_stand ~ ~ ~ {Marker:1,Invulnerable:1,Tags:["damnum"],CustomNameVisible:1b,Duration:999999,CustomName:'{"text":"-16"}'}
execute as @s[scores={healthreal=17}] at @s run summon minecraft:armor_stand ~ ~ ~ {Marker:1,Invulnerable:1,Tags:["damnum"],CustomNameVisible:1b,Duration:999999,CustomName:'{"text":"-17"}'}
execute as @s[scores={healthreal=18}] at @s run summon minecraft:armor_stand ~ ~ ~ {Marker:1,Invulnerable:1,Tags:["damnum"],CustomNameVisible:1b,Duration:999999,CustomName:'{"text":"-18"}'}
execute as @s[scores={healthreal=19}] at @s run summon minecraft:armor_stand ~ ~ ~ {Marker:1,Invulnerable:1,Tags:["damnum"],CustomNameVisible:1b,Duration:999999,CustomName:'{"text":"-19"}'}
execute as @s[scores={healthreal=20}] at @s run summon minecraft:armor_stand ~ ~ ~ {Marker:1,Invulnerable:1,Tags:["damnum"],CustomNameVisible:1b,Duration:999999,CustomName:'{"text":"-20"}'}
execute as @s[scores={healthreal=21}] at @s run summon minecraft:armor_stand ~ ~ ~ {Marker:1,Invulnerable:1,Tags:["damnum"],CustomNameVisible:1b,Duration:999999,CustomName:'{"text":"-21"}'}
execute as @s[scores={healthreal=22..}] at @s run summon minecraft:armor_stand ~ ~ ~ {Marker:1,Invulnerable:1,Tags:["damnum"],CustomNameVisible:1b,Duration:999999,CustomName:'{"text":"-22"}'}

execute as @s[scores={healthreal=1..},tag=!zeroh] at @s run particle minecraft:block minecraft:redstone_block ~ ~1 ~ .3 .8 .3 2 40 force
effect give @s[scores={health=..59}] minecraft:instant_health 900 9 true
effect give @s[scores={health=..59}] minecraft:absorption 900 9 true
