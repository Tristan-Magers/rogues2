...
scoreboard players set @s damageCap 140
scoreboard players set @s[scores={class=1}] damageCap 50
scoreboard players set @s[scores={class=2},nbt={SelectedItem:{id:"minecraft:wooden_hoe"}}] damageCap 40
scoreboard players set @s[scores={class=2},nbt={SelectedItem:{id:"minecraft:stone_hoe"}}] damageCap 50
scoreboard players set @s[scores={class=2},nbt={SelectedItem:{id:"minecraft:iron_hoe"}}] damageCap 60
scoreboard players set @s[scores={class=2},nbt={SelectedItem:{id:"minecraft:golden_hoe"}}] damageCap 70
scoreboard players set @s[scores={class=2},nbt={SelectedItem:{id:"minecraft:diamond_hoe"}}] damageCap 80
scoreboard players set @s[scores={class=3}] damageCap 70
scoreboard players set @s[scores={class=4}] damageCap 70
scoreboard players set @s[scores={class=5}] damageCap 130
scoreboard players set @s[scores={class=6}] damageCap 130
