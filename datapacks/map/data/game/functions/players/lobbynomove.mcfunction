...
replaceitem entity @s[scores={class=2},tag=ready] armor.head minecraft:melon_seeds
replaceitem entity @s[scores={class=4},tag=ready] armor.head minecraft:gold_nugget
replaceitem entity @s[scores={class=1},tag=ready] armor.head minecraft:pink_dye
replaceitem entity @s[scores={class=3},tag=ready] armor.head minecraft:cyan_dye
replaceitem entity @s[scores={class=5},tag=ready] armor.head minecraft:light_gray_dye
replaceitem entity @s[scores={class=6},tag=ready] armor.head minecraft:gray_dye
