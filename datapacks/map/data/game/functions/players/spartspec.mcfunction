execute if entity @e[scores={map=1..5}] run tag @s add spec
execute if entity @e[scores={map=1..5}] run tag @s remove ready

execute if entity @e[scores={map=1..5}] run gamemode spectator
