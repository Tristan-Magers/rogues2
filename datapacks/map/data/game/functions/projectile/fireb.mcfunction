...
execute as @s[scores={press=12..,flameT=0},nbt={Small:1b}] at @s run fill ~1 ~2 ~1 ~-1 ~-2 ~-1 minecraft:air replace fire
execute as @s[scores={press=12..190,flameT=0},nbt={Small:0b}] at @s run fill ~1 ~2 ~1 ~-1 ~-2 ~-1 minecraft:fire replace air
