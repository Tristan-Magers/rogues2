...
execute as @s[scores={timer=1006}] at @s run summon area_effect_cloud ~ ~.3 ~ {Particle:"minecraft:crit",ReapplicationDelay:0,RadiusPerTick:-.05f,Radius:3f,Duration:60,Potion:"minecraft:harming",Tags:["thorns"]}
