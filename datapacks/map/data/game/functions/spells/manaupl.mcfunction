...
item replace entity @s[tag=ready,gamemode=adventure,nbt=!{Inventory:[{id:"minecraft:magma_cream",Slot:7b}]}] hotbar.7 with minecraft:magma_cream{display:{Name:"[{\"text\":\"In-Game\",\"color\":\"dark_aqua\",\"italic\":\"false\",\"bold\":\"true\"},{\"text\":\" [\",\"color\":\"white\",\"italic\":\"false\"},{\"text\":\"Leave Game\",\"color\":\"gold\",\"italic\":\"false\"},{\"text\":\"]\",\"color\":\"white\",\"italic\":\"false\"}]"}}
clear @s[tag=!ready,gamemode=adventure,nbt=!{Inventory:[{id:"minecraft:spider_eye",Slot:7b}]}] spider_eye
item replace entity @s[tag=!ready,gamemode=adventure,nbt=!{Inventory:[{id:"minecraft:spider_eye",Slot:7b}]}] hotbar.7 with minecraft:spider_eye{display:{Name:"[{\"text\":\"Not In-Game\",\"color\":\"red\",\"italic\":\"false\",\"bold\":\"true\"},{\"text\":\" [\",\"color\":\"white\",\"italic\":\"false\"},{\"text\":\"Join Game\",\"color\":\"gold\",\"italic\":\"false\"},{\"text\":\"]\",\"color\":\"white\",\"italic\":\"false\"}]"}}